 ...
 *                  - (0) if ok
 */
int resizeUp(ArrayList* this)  //creo q esta bien, preguntar al profe
{
    int returnAux= -1;
    void** aux;
 ...
 *                  - ( 0) if Ok
 */
int expand(ArrayList* this,int index) //creo q esta bien, preguntar al profe
{
 ...
 *                  - ( 0) if Ok
 */
int contract(ArrayList* this,int index)  //creo q esta bien, preguntar al profe
{
    int returnAux = -1, i;
